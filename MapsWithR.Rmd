...
#loading Shapefiles
my_sf <- st_read("Data/ne_10m_admin_0_countries/ne_10m_admin_0_countries.shp")
...
```{r, echo =TRUE}
my_sdg <- read.csv("Data/SG_GEN_PARL_ap.csv", sep = ",")
...
my_geodata <- merge(my_sf_asia, my_sdg, by.x= "NAME_LONG", by.y = "GeoAreaName") %>%
  st_crop(c(xmin = 60, xmax = 180, ymin = -50, ymax = 70))  # Adjusted bounding box
```
