...
\begin{center}
\begin{itemize}
   \only<1>{\includegraphics[width=0.9\textwidth]{MEDITERRANEAN_ATLAS_06_V3_1500.jpg} \\ }
   \only<1>{\textcolor{gris}{\href{https://atlasofplaces.com/research/mediterranean-sea-collection/}{Source: Atlas of places}}}
   \only<2>{\centering \includegraphics[width=0.6\textwidth]{M5-Flag_of_the_United_Nations.png} \\ }
   ...
   \only<3>{\includegraphics[width=0.6\textwidth]{M5-Flows-Mobile.jpg} \\ }
   \only<3>{\textcolor{gris}{\href{https://www.worldpop.org/focus_areas\#case3}{Source: World Pop}}}
   \only<4>{\includegraphics[width=0.8\textwidth]{LondonDammagesWWII.jpg} \\ }
...
\begin{center}
\begin{itemize}
   \only<1>{\includegraphics[width = 0.8\textwidth]{WorldMercator0.JPG} \\ }
   ...
   \only<4>{\includegraphics[width = 0.8\textwidth]{M5-Mercator.PNG} \\ }
...
\frametitle{\textcolor{brique}{[-  \textbf{Maps have limitations} -]}}
    \begin{columns}
        \column{0.4\textwidth}
            ...
            \end{itemize}
        \column{0.6\textwidth}
            \only<1>{\includegraphics[width = 0.9\textwidth]{BadGermanyMapwithPies.JPG} \\ }
            \only<1>{\textcolor{gris}{\footnotesize{\href{https://www.destatis.de/EN/Press/2020/12/PE20_476_435.html}{Statistisches Bundesam}}}}
            \only<2>{\includegraphics[width=1.0\textwidth]{ShareWomenParliament-map.png} }
            \only<2>{\textcolor{gris}{\footnotesize{\href{https://ourworldindata.org/women-rights}{Our World in Data}}}}
            \only<3>{\includegraphics[width=1.0\textwidth]{ShareWomenParliamentChoro1.png} }
            \only<4>{\includegraphics[width=1.1\textwidth]{ShareWomenParliamentSymb-Big.png} }
...
\begin{itemize}
   ...
   \only<1>{\includegraphics[width = 0.5\textwidth]{Color-Munsell-system.Wikipedia.png} \\ }
   ...
   \only<2>{\includegraphics[width = 0.8\textwidth]{ShareWomenParliamentChoro2.png} \\ }
   \only<3>{\includegraphics[width = 0.8\textwidth]{ShareWomenParliamentChoro1.png} \\ }
   \only<4>{\includegraphics[width = 0.8\textwidth]{ShareWomenParliamentChoroCont.png} \\ }
...
\begin{center}
\begin{itemize}
   \only<1>{\includegraphics[width = 0.7\textwidth]{Yau-MapsColors-Qualitative.jpg} \\ }
   \only<1>{\footnotesize{For \textbf{qualitative} variables: Gender, land type, Religion.\\
                    $\hookrightarrow$ Different \textit{hues}} \\ }
   \only<2>{\includegraphics[width = 0.7\textwidth]{Yau-MapsColors-Sequential.jpg} \\ }
   ...
   \only<3>{\includegraphics[width = 0.7\textwidth]{Yau-MapsColors-Diverging.jpg} \\ }
...
\begin{itemize}
   ...
   \only<1>{\includegraphics[width = 0.7\textwidth]{M5-ColourBrewer.PNG} \\  }
   ...
   \only<3>{\includegraphics[width = 0.8\textwidth]{M5-ColourCulture.png} \\   }
   ...
   \only<4-5>{Keep the message simple}
   \only<4>{\includegraphics[width = 0.8\textwidth]{UNWomen-WomenPolitics2025.png} \\   }
   \only<5>{\includegraphics[width = 0.7\textwidth]{UNWomen-WomenPolitics2025-AP.png} \\   }
...
\begin{itemize}
   ...
   \only<7>{\includegraphics[width = 0.6\textwidth]{ShareWomenParliament-BarChart.png} \\  }
...
\begin{itemize}
   ...
   \only<3>{\includegraphics[width = 0.6\textwidth]{M5-Cartogram_Africa1.PNG} \\  }
   \only<4>{\includegraphics[width = 0.6\textwidth]{M5-Cartogram_Africa2.PNG} \\  }
   \only<3-4>{\textcolor{gris}{\footnotesize{Source: \href{https://www.r-graph-gallery.com/cartogram.html}{Yan Holtz-  From-Data-to-Viz}}} \\ }
   \only<5>{Other types of cartograms (weighting by GDP) \\ }
   \only<5>{\includegraphics[width = 0.6\textwidth]{M5-IndiaGDP-Geo.PNG} \\  }
   \only<6>{Continuous cartogram\\ }
   \only<6>{\includegraphics[width = 0.6\textwidth]{M5-IndiaGDP-Carto.PNG} \\  }
   \only<7>{Dorling\\ }
   \only<7>{\includegraphics[width = 0.55\textwidth]{M5-IndiaGDP-Dorling.PNG} \\  }
   \only<8>{Hexagonal Tiling \\ }
   \only<8>{\includegraphics[width = 0.55\textwidth]{M5-IndiaGDP-Hex.PNG} \\  }
   \only<5-8>{\textcolor{gris}{\footnotesize{Source: \href{https://atlan.com/courses/introduction-to-gis-r/lesson4-animated-interactive-maps/\#gis-ch4-nom_gdp_anim}{Sean Angiolillo}}} \\ }
\end{itemize}
\end{center}
\end{frame}
