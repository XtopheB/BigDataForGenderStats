...
# Conclusion for year `r MyYear`
 In this report, we explored the indicator **5.5.1** *Proportion of seats held by women in national parliaments* for **`r nrow(GenderData)`** countries, as a table and as a graphic for the selected year (**`r MyYear`**) by just changing **one parameter** `MyYear` at the beginning of the document. 
