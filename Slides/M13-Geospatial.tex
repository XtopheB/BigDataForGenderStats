...
\pause
    \begin{columns}[T]
        ...
        \begin{itemize}
             ...
             \only<3-5>{ \includegraphics[width=\textwidth]{Raster.png} \\  }
             \only<6-8>{  \includegraphics[width=\textwidth]{Vector.png}\\  }
...
\pause
    \begin{columns}[T]
        ...
        \begin{itemize}
             \item[]
             \only<2>{
             \includegraphics[width=0.4\textwidth]{AreaGISInformation1.png} \includegraphics[width=0.4\textwidth]{AreaGISInformation2.png} \\
             ...
             \only<3>{ \includegraphics[width=0.8\textwidth]{CRS.png} \\
             ...
             \only<5-6>{ \vspace{2.5cm} \includegraphics[width=0.3\textwidth]{QGIS.jpg} \\  }
             \only<6>{ \vspace{0.2cm}\includegraphics[width=0.3\textwidth]{R_logo.svg.png} \\  }
             %\only<5-7>{   \textcolor{gris}{\footnotesize{Source: \href{https://desktop.arcgis.com/en/arcmap/10.3/manage-data/raster-and-images/what-is-raster-data.htm}{Arcgis}}} }
        \end{itemize}
        \end{column}
    \end{columns}
