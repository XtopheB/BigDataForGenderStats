...
\end{column}
  \begin{column}{0.5\textwidth}
    \begin{center}
      \only<1-4>{ \includegraphics[width=0.8\textwidth]{RMarkdownDoc.png} }
      \only<5-7>{ \includegraphics[width=0.9\textwidth]{RMarkdownExport.jpg} \\ }
      \only<8>{ \large  \textcolor{siap}{Demo!} \\
      \includegraphics[width=0.6\textwidth]{RMarkdownDoc.png}}
   \end{center}
  \end{column}
\end{columns}
\end{frame}
